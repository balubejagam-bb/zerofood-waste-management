...
<script>
    <?php
        ...
        // Updated queries for Andhra Pradesh districts
        $districts = [
            "Srikakulam",
        ...
        foreach ($districts as $district) {
            $q = "SELECT count(*) as count FROM food_donations where location=\"$district\"";
            $res = mysqli_query($connection, $q);
            $ro = mysqli_fetch_assoc($res);
            $donation_counts[$district] = $ro['count'];
        }

    ?>
    var xValues = ["Male", "Female"];
    var xplace = <?php echo json_encode(array_keys($donation_counts), JSON_HEX_TAG); ?>;
    var yplace = <?php echo json_encode(array_values($donation_counts), JSON_HEX_TAG); ?>;
