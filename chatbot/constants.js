...
const prompts = [
  ...
  const replies = [
    ...
    ["how to donate food ,i will guide you to donate food,firstly go to the homepage then click on the donate food option and fill the required information and click on donate food button then our delivery partner wwill reach you to collect food"]
  ]
